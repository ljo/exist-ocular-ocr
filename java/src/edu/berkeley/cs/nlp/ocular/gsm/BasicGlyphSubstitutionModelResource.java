 ...
 */
public class BasicGlyphSubstitutionModelResource implements GlyphSubstitutionModel {
	...
	public BasicGlyphSubstitutionModelResource(double[][][] probs,
			double gsmPower,
...
//			}
		...
		public BasicGlyphSubstitutionModelResource make(double[/*language*/][/*lmChar*/][/*glyph*/] counts, int iter, int batchId) {
			...
			return new BasicGlyphSubstitutionModelResource(probs, gsmPower, langIndexer, charIndexer);
		}

		public BasicGlyphSubstitutionModelResource makeForEval(double[/*language*/][/*lmChar*/][/*glyph*/] counts, int iter, int batchId) {
			return makeForEval(counts, iter, batchId, minCountsForEvalGsm);
		}

		public BasicGlyphSubstitutionModelResource makeForEval(double[/*language*/][/*lmChar*/][/*glyph*/] counts, int iter, int batchId, double minCountsForEvalGsm) {
...
//			}
			...
			FileHelperResource.writeString(outputFilename, sb.toString());
		}
