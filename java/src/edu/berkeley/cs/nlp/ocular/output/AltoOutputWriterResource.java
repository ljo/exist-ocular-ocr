 ...
 */
public class AltoOutputWriterResource {
	...
	public AltoOutputWriterResource(Indexer<String> charIndexer, Indexer<String> langIndexer) {
...
//			outputBuffer.append("      </postProcessingStep>\n");
		...
		fResource.writeString(altoOutputFilename, outputString);
	}
