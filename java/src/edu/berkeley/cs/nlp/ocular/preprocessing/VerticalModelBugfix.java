 ...
 */
public class VerticalModelBugfix {
  ...
  public static class SuffStats {
    ...
    public SuffStats(VerticalProfileBugfix profile, int state, int start, int stop, double mass) {
      Arrays.fill(totalMass, 0);
      Arrays.fill(totalMassTimesLength, 0);
      Arrays.fill(totalEmissionMass, 0);
      Arrays.fill(totalSizeMass, 0);
...
//  public static final int[] maxSizes = { 100, 100, 100 };
//  public static final int[] maxSizes = { 150, 150, 150 };
//  public static final int[] maxSizes = { 250, 250, 250 };
    final int[] minSizes;
    final int[] maxSizes;
  
  public static VerticalModelBugfix getRandomlyInitializedModel(int imageWidth, Random rand, int[] minSizes, int[] maxSizes) {
...
//	  emissionMeans[2] = 0.0 * imageWidth;
	  ...
	  return new VerticalModelBugfix(imageWidth, emissionMeans, emissionVariance, sizeMeans, sizeVariances, minSizes, maxSizes);
  }
  
  public VerticalModelBugfix(int imageWidth, double[] emissionMeans, double emissionVariance, double[] sizeMeans, double[] sizeVariances, int[] minSizes, int[] maxSizes) {
...
//      assert Math.abs(a.sum(a.exp(this.emissionLogProbs[i])) - 1.0) < 1e-8 : a.sum(a.exp(this.emissionLogProbs[i]));
  ...
  public double getLogProb(VerticalProfileBugfix profile, int stateIdx, int posn) {
  ...
  public double getLogProb(VerticalProfileBugfix profile, int stateIdx, int start, int stop) {
