 ...
 */
public class HtmlOutputWriterResource {
	
	private Indexer<String> charIndexer;
	private Indexer<String> langIndexer;
	
	public HtmlOutputWriterResource(Indexer<String> charIndexer, Indexer<String> langIndexer) {
	...
	public void write(int numLines, List<TransitionState>[] viterbiTransStates, String imgFilename, String outputFilenameBase) {
		...
		outputBuffer.append("</td><td><img src=\"" + FileUtil.pathRelativeTo(imgFilename, new File(outputFilenameBase).getParent()) + "\" />\n");
