 ...
 */
public class ReplaceSomeTextReaderResource implements TextReader {
	 ...
	 */
	public ReplaceSomeTextReaderResource(List<Tuple2<Tuple2<List<String>, List<String>>, Integer>> rules, TextReader delegate) {
		this.rules = rules;
	...
	public static List<Tuple2<Tuple2<List<String>, List<String>>, Integer>> loadRulesFromFile(String path) {
		...
		for (String line : fResource.readLines(path)) {
